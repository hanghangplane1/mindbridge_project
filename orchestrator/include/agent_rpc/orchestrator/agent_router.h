 ...
 * 
 * Features:
 * - Multiple routing strategies (round-robin, random, skill-match, least-load, consistent-hash)
...
public:
     ...
     * @param routing_key Optional affinity key used by consistent-hash routing
...
private:
     ...
     * @param routing_key Optional affinity key for consistent-hash selection
    ...
    /**
     * @brief Select using consistent-hash strategy
     */
    AgentInfo selectConsistentHash(const std::vector<AgentInfo>& candidates,
                                   const std::string& routing_key);

    /**
     * @brief Resolve the effective routing key for consistent-hash selection
     */
    std::string resolveRoutingKey(const std::string& question,
                                  const std::vector<std::string>& required_skills,
