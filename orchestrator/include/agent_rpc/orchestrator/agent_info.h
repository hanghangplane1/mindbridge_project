...
enum class RoutingStrategy {
    ...
    CONSISTENT_HASH // Select agent with stable key-based affinity
};
...
inline std::string to_string(RoutingStrategy strategy) {
    switch (strategy) {
        ...
        case RoutingStrategy::CONSISTENT_HASH: return "consistent_hash";
...
inline RoutingStrategy routing_strategy_from_string(const std::string& str) {
    ...
    if (str == "consistent_hash") return RoutingStrategy::CONSISTENT_HASH;
